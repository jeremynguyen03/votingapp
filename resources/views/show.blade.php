    ...
    <div class="button-container flex items-center justify-between mt-6">
        <div class="flex items-center space-x-4 ml-6">
            <div class="relative">
                ...
                <div class="absolute z-10 w-104 text-left font-semibold text-sm bg-white rounded-xl mt-2 shadow-dialog">
                    <form action="#" class="space-y-4 px-4 py-6">
                        ...
                        <div class="flex items-center space-x-3">
                            <button type="button"
                                    class="justify-center flex items-center w-1/2 h-11 text-xs bg-blue text-white
                            font-semibold rounded-xl border border-blue hover:bg-blue-hover
                            transition duration-150 ease-in px-6 py-3">Post Comment</button>

                            <button type="button"
                                    class="justify-center flex items-center w-32 h-11 text-xs bg-gray-200
            ...
            <div class="relative">
                <button type="button"
                        class="justify-center flex w-36 h-11 text-sm bg-gray-200
                            font-semibold rounded-xl border border-gray-200 hover:border-gray-400
                            transition duration-150 ease-in px-6 py-3">
                ...
                <div class="absolute z-20 w-76 text-left font-semibold text-sm bg-white rounded-xl mt-2 shadow-dialog">
                    <form action="#" class="space-y-4 px-4 py-6">
                        <div class="space-y-2">
                            <div>
