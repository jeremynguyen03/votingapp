            ...
            <div class="md:w-full mx-2 md:mx-4 text-justify">
                ...
                <div class="flex flex-col md:flex-row md:items-center justify-between mt-6">
                    <div class="flex items-center text-xs text-gray-400 font-semibold space-x-2">
                        <div class="hidden md:block font-bold text-gray-900">Jeremy</div>
                        ...
                        <div class="flex flex-col md:flex-row items-center md:space-x-3">
                            <button type="button"
                                    class="flex items-center justify-center h-11 w-full md:w-1/2 text-xs
                                           ...
                                           hover:bg-blue-hover transition duration-150 ease-in px-6 py-3">Post Comment</button>
                        ...
                        <div
                            ...
                            <button
                                ...
                                <ul
                                    ...
                                    @click.away="isOpen = false"
                                    @keydown.esc.window="isOpen = false"
                                    class="absolute w-44 z-10 text-left font-semibold bg-white shadow-dialog rounded-xl py-3 ml-8 md:ml-8 top-8 md:top-6 right-0 md:left-0"
                                >
                                    <li><a href="#"
