        ...
        <div class="flex items-center space-x-4 ml-6">
            ...
            >
                ...
                <div
                    ...
                    @click.away="isOpen = false"
                    @keydown.esc.window="isOpen = false"
                    class="absolute z-10 w-104 text-left font-semibold text-sm bg-white rounded-xl mt-2 shadow-dialog"
                >
            ...
            >
                ...
                <div
                    ...
                    @click.away="isOpen = false"
                    @keydown.esc.window="isOpen = false"
                    class="absolute z-20 w-76 text-left font-semibold text-sm bg-white rounded-xl mt-2 shadow-dialog"
                >
                    <form action="#" class="space-y-4 px-4 py-6">
                        <div class="space-y-2">
                            <div>
