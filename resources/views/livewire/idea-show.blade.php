{{--  begin idea-and-button container  --}}
        ...
        <div class="flex flex-col md:flex-row flex-1 px-4 py-6">
            ...
            <div class="md:w-full mx-2 md:mx-4 text-justify">
                ...
                <div class="flex flex-col md:flex-row md:items-center justify-between mt-6">
                    ...
                    >
                        <div
                            class="text-xxs font-bold uppercase leading-none rounded-full text-center w-28 h-7 py-2 px-4 {{ $idea->status->classes }}">{{ $idea->status->name }}</div>
                        <button
                            @click="isOpen = !isOpen"
                ...
                >
                    <form action="#" class="space-y-4 px-4 py-6">
                        ...
                        <div class="flex flex-col md:flex-row items-center md:space-x-3">
                            <button type="button"
                                    class="flex items-center justify-center h-11 w-full md:w-1/2 text-xs
                                           bg-blue text-white font-semibold rounded-xl border border-blue
                                           hover:bg-blue-hover transition duration-150 ease-in px-6 py-3">Post Comment
                            </button>

                            <button type="button"
                                    class="justify-center flex items-center w-full md:w-32 h-11 text-xs bg-gray-200
            ...
            >
                <button
                    ...
                    class="flex items-center justify-center w-36 h-11 text-sm bg-gray-200 font-semibold
                           rounded-xl border border-gray-200 hover:border-gray-400 transition duration-150 ease-in
        ...
        <div class="hidden md:flex items-center space-x-3">
            ...
            @if($hasVoted)
                <button
                    wire:click.prevent="vote"
                    type="button"
                    class="w-32 h-11 text-xs bg-blue font-semibold text-white uppercase rounded-xl border border-blue hover:border-blue-hover transition duration-150 ease-in px-6 py-3">
                    <span>Voted</span>
                </button>
            @else
                <button
